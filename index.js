...
const monsterImgs = ['baby_jombee@300x-8 1.png', 'baby_jombee@300x-8 2.png', 'baby_jombee@300x-8 3.png']
...
function letShipFly(event) {
    ...
    {
    ctx.rotate(angle)
    const centerX = player-controlled-shooter .width / 2,
        centerY = player-controlled-shooter .height / 2;
...
function gameOver() {
  ...
  setTimeout(() => {
    alert(`Game Over!  ${scoreCounter.innerText}!`)
